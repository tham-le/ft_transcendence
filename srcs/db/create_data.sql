...
VALUES
('user1', 'user1@email.com', 'password1', 'User', 'One', 'Male', 25, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('user2', 'user2@email.com', 'password2', 'User', 'Two', 'Female', 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

-- Insertion de données dans la table "game"
INSERT INTO "game" ("name", "image", "dascritpion", "genre")
VALUES
('Game1', '/var/www/default_game.webp', 'Description for Game1', 'FPS'),
('Game2', '/var/www/default_game.webp', 'Description for Game2', 'retro');
